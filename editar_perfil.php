        ...
        <section class="col-lg-12">
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="Nombre" class="form-control" value="PHP Nombre actual">
                    </div>
                </div>
                <div class="form-group">
                    <label for="Apellidos" class="col-sm-2 control-label">Apellidos</label>
                    <div class="col-sm-6">
                        <input id="Apellidos" class="col-sm-6 form-control" value="PHP Apellidos actuales">
                    </div>
                </div>
                <!-- Modificar Password } -->
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="email" id="Email" class="col-sm-6 form-control" value="PHP Email actual">
                    </div>
                </div>
                <div class="form-group">
                    <label for="tlf" class="col-sm-2 control-label">Teléfono</label>
                    <div class="col-sm-3">
                        <input type="tel" id="tlf" class="form-control" value="PHP Teléfono actual">
                    </div>
                </div>
                <!-- Location -->
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select id="pais" class="form-control">
                            ...
                            <option selected="selected" value="Spain" title="Spain">Spain</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <img id=show-avatar src="images/avatar.jpg" class="img-responsive img-rounded">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" id="Pass-old" class="form-control tip">
                    </div>
                </div>
                <div class="form-group">
